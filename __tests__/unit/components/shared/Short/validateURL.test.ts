...
describe("isUrlValid", () => {
  ...
  it("returns 'Please enter a valid link' error message when url is invalid", () => {
    ...
    expect(validateUrl("http://")).toBe("Please enter a valid link");
    expect(validateUrl("http://www.")).toBe("Please enter a valid link");
    expect(validateUrl("http://www.f")).toBe("Please enter a valid link");
    expect(validateUrl("http://www.@")).toBe("Please enter a valid link");
    expect(validateUrl("http://www.frontendmentor")).toBe(
  ...
  it("returns empty error message when url is valid", () => {
    expect(validateUrl("http://www.frontendmentor.io")).toBe("");
    expect(validateUrl("https://www.frontendmentor.io")).toBe("");
