...
export default function Footer() {
  return (
    <footer className={styles.footerCont}>
      ...
      {/*Page and Social Links*/}
      <div className={styles.linksCont}>
        {/*Page Links*/}
        {/*Features*/}
        <nav className={styles.navCont}>
          <h3 className={styles.navTitle}>Features</h3>
          <ul className={styles.pageLinksCont}>
            <li>
        ...
        {/*Social Links*/}
        <nav className={styles.socialsNavCont}>
          <h3 className="sr-only">Social Links</h3>
          <ul className={`flex-center ${styles.socialLinksCont}`}>
            {/*Facebook*/}
            <li>
              <a className={styles.teste} href="#" aria-label="Facebook">
                <svg
